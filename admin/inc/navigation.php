<style>
  ...
  .sidebar-light-blue .brand-link {
    background-color: #87CEEB;
    color: #ffffff !important;
  }
  .sidebar-light-blue .nav-sidebar > .nav-item > .nav-link {
    color: #000000;
  }
  ...
  .sidebar-light-blue .nav-sidebar > .nav-item > .nav-link:hover {
  ...
  .sidebar-light-blue .nav-treeview > .nav-item > .nav-link.active {
    background-color: #87CEEB;
    color: #ffffff !important;
  }
...
<aside class="main-sidebar sidebar-light-blue navbar-light elevation-4 sidebar-no-expand">
  <!-- Brand Logo -->
...
$(document).ready(function(){
  ...
  $('.nav-link.active').addClass('bg-gradient-lightblue')
})
</script>
