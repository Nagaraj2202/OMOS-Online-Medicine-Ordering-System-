<style>
  ...
  .navbar-lightblue .navbar-toggler-icon {
    color: #ffffff; /* White color for contrast */
  }
  .navbar-lightblue .dropdown-menu {
    background-color: #add8e6; /* Light blue color for dropdown */
  }
  .navbar-lightblue .dropdown-item {
    color: #ffffff; /* White color for contrast */
  }
  .navbar-lightblue .dropdown-item:hover {
    background-color: #87cefa; /* Light sky blue color on hover */
  }
</style>
  ...
  <div class="container px-4 px-lg-5">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
        ...
        <li class="nav-item"><a class="nav-link" href="./?p=products">Products</a></li>
        ...
        <?php if ($_settings->userdata('id') != '' && $_settings->userdata('login_type') == 2): ?>
          <li class="nav-item"><a class="nav-link" href="./?p=cart_list">Cart <span class="ml-2 badge badge-primary"><?= $cart > 0 ? format_num($cart) : '' ?></span></a></li>
        <?php endif;?>
      </ul>
