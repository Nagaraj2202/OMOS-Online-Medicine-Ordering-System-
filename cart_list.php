                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            ...
                            <div class="py-1 text-center">
                                ...
                                <form action="./?p=checkout" method="post" id="checkout-form">
                                    ...
                                    <button type="submit" class="btn btn-lg btn-default text-light bg-gradient-maroon col-lg-4 col-md-6 col-sm-12 col-xs-12 rounded-pill">Checkout</button>
                                </form>
                            </div>
                            <?php endif; ?>
                        </div>
...
<script>
    function update_item(cart_id = '', qty = 0){
        start_loader()
        $.ajax({
            url:base_url+'classes/Master.php?f=update_cart',
            method:'POST',
    ...
    function delete_cart($id){
		start_loader();
		$.ajax({
			url:base_url+"classes/Master.php?f=delete_cart",
			method:"POST",
			data:{id: $id},
			dataType:"json",
			error:err=>{
